    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 18rem; max-height:33rem">
                    <a href="/posts?category={{ $post->category->slug }} "class="position-absolute px-3 py2 text-white text-decoration-none" style="background-color: rgba(0,0,0,0.7);">{{ $post->category->name }}</a>
                    ...
                    <div class="card-body">
                      <h5 style="max-height: 48px; overflow:hidden;" class="card-title">{{ $post->title }}</h5>
                        <small class="text-muted">
                      ...
                      <p style="max-height: 90px; overflow:hidden;" class="card-text">{{ $post->excerpt }}</p>
